...
<div class="row justify-content-center">
	<div class="col-12">
			...
			<div class="col">
				<div class="card card-stats">
					<div class="card-body">
						...
						<p class="mt-3 mb-0 text-sm">
						</p><h5 class="card-title  text-muted mb-0">{{ __('Today's Transactions') }}</h5>
						<p></p>
					</div>
				</div>
			</div>
		...
		@else
		<div class="alert  bg-gradient-primary text-white"><span class="text-left">{{ __('Oops There Is No Transaction Found....') }}</span></div>
		@endif
	</div>
</div>
@endsection
