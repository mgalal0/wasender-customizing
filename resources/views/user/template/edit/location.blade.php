   ...
   <div class="row">
      ...
      <div class="col-sm-6">
         <div class="form-group">
            ...
            <input type="number" step="any" name="degreesLatitude" required="" class="form-control" placeholder="{{ __('Example: 24.1212312') }}" value="{{ $template->body['location']['degreesLatitude'] ?? '' }}">
         </div>
      </div>
      <div class="col-sm-6">
         <div class="form-group">
            <label>{{ __('Longitude') }}</label>
            <input type="number" step="any" name="degreesLongitude" required="" class="form-control" placeholder="{{ __('Example: 55.1121221') }}" value="{{ $template->body['location']['degreesLongitude'] ?? '' }}">
         </div>
      </div>
      <div class="col-sm-12">
         <div class="row">
