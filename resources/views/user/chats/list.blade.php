			...
			<div class="col-sm-8 mt-5" >
					...
					<form method="post" class="ajaxform" action="{{ route('user.chat.send-message',$device->uuid) }}">
						...
						<div class="input-group none sendble-row wa-content-area" >
							...
							@endif
							<input type="text" name="message" class="form-control" id="plain-text" placeholder="{{ __('Message') }}" aria-label="{{ __('Recipient\'s username') }}" aria-describedby="basic-addon2">
