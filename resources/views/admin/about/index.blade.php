	...
	<div class="col-12 col-sm-12 col-lg-12">
		<div class="card">
			<div class="card-header">
				<h4>{{ __('About Us')  ." ( ".strtoupper($locale)." )" }}</h4>
			</div>
			<div class="card-body">
				<div class="row">
							...
							<div class="tab-pane fade show active" id="home4" role="tabpanel" aria-labelledby="home-tab4">
								<form method="post" action="{{ route('admin.about.store') }}" enctype="multipart/form-data" class="ajaxform">
									...
									<div class="form-group">
										...
										<input type="text" name="breadcrumb_title" required="" class="form-control" value="{{ $about->breadcrumb_title ?? '' }}" placeholder="{{ __('About Us') }}">
									</div>
									<div class="form-group">
										<label>{{ __('Section Title:') }}</label>
										<input type="text" name="section_title" required="" class="form-control" value="{{ $about->section_title ?? '' }}" placeholder="{{ __('Over 12 years of experience in the IT Industry & Tech service') }}">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<input type="text" name="experience_title" required="" class="form-control" value="{{ $about->experience_title ?? '' }}" placeholder="{{ __('Years of Experience') }}">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<input type="text" name="button_title"  class="form-control" value="{{ $about->button_title ?? ''  }}" placeholder="{{ __('Check our work') }}">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<textarea class="form-control" name="facilities" placeholder="{{ __('example1, example2') }}">{{ $about->facilities ?? '' }}</textarea>
