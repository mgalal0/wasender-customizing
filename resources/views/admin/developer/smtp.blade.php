        ...
        <form class="ajaxform" action="{{ route('admin.developer-settings.update',$id) }}">
            ...
            <div class="card-body">
                ...
                <div class="from-group row mt-2">
                    ...
                    <div class="col-lg-12">
                     <input type="email"   name="MAIL_FROM_ADDRESS" class="form-control" placeholder="{{ __('email') }}" required="" value="{{ env('MAIL_FROM_ADDRESS') }}">
                    </div>
                </div>
                <div class="from-group row mt-2">
                    <label class="col-lg-12">{{ __('Mail From Name') }}</label>
                    <div class="col-lg-12">
                     <input type="text"   name="MAIL_FROM_NAME" class="form-control" placeholder="{{ __('Website Name') }}" required="" value="{{ env('MAIL_FROM_NAME') }}">
                    </div>
                </div>
                <div class="from-group row mt-2">
                    <label class="col-lg-12">{{ __('Incoming Mail') }}</label>
                    <div class="col-lg-12">
                     <input type="email"   name="MAIL_TO" class="form-control" placeholder="{{ __('email') }}" required="" value="{{ env('MAIL_TO') }}">
                    </div>
                </div>
