    ...
    <div class="col-lg-7 mt-5">
        <form class="ajaxform" action="{{ route('admin.developer-settings.update',$id) }}">
            ...
            <div class="card-body">
                ...
                <div class="from-group row mt-2">
                    <label class="col-lg-12">{{ __('Max Retries') }}</label>
                    <div class="col-lg-12">
               ...
               <div class="from-group row mt-2">
                    ...
                    <div class="col-lg-12">
                        <input type="number" name="DELAY_TIME"  value="{{ env('DELAY_TIME') }}" required="" class="form-control" placeholder="{{ __('1000 ms = 1 sec') }}">
                    </div>
                </div>
