							...
							<div class="custom-form">
								<div class="form-group">
									...
									<div class="input-group">
										<input type="text" class="form-control item-menu" name="text" id="text" placeholder="{{ __('Text') }}" autocomplete="off">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control item-menu" id="href" name="href" placeholder="{{ __('URL') }}" required autocomplete="off">
								</div>
								<div class="form-group">
