                        ...
                        <div class="pt-20">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" placeholder="Enter Email" name="email" class="form-control"
                                       id="email" required="" value="{{ $user->email }}" autocomplete="off">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" placeholder="Confirm Password" name="password_confirmation"
                                       class="form-control" id="password_confirmation" value="" autocomplete="off">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="status" class="form-control">
                                    ...
                                    <option value="0"
                                            @if($user->status==0) selected @endif> {{ __('Deactivated') }}</option>
