         ...
         <div class="col-12">
            ...
            <div class="tp-choose__thumb-box d-flex justify-content-center">
               <div class="tp-choose__thumb-sm">
                  <a href="{{ url(get_option('why-choose',true, true, false, current_locale())->left_button_link ?? '') }}"><img src="{{ asset(get_option('why-choose',true, true, false, current_locale())->left_button_image ?? '') }}" alt=""></a>
               </div>
               <div class="tp-choose__thumb-sm">
                  <a href="{{ url(get_option('why-choose',true, true, false, current_locale())->right_button_link ?? '') }}"><img src="{{ asset(get_option('why-choose',true, true, false, current_locale())->right_button_image ?? '') }}" alt=""></a>
               </div>
            </div>
         </div>
      </div>
