...
<div class="tp-hero__area tp-hero__bg p-relative" data-background="{{ asset('assets/frontend/img/hero/hero-bg.png') }}">
   <div class="scroll-down smooth d-none d-xl-block">
      <a href="#feature-area">
         <div class="scroll-dots d-flex justify-content-center flex-column align-items-center">
            <span class="rotate-text">{{ __('Scroll Down') }}</span>
   ...
   <div class="tp-hero__social d-none d-xl-flex">
      ...
      <a class="p-relative" href="{{ get_option('primary_data',true,true,false,current_locale())->socials->twitter }}"><i class="fab fa-twitter"></i>
      ...
      <a class="p-relative" href="{{ get_option('primary_data',true,true,false,current_locale())->socials->instagram }}"><i class="fab fa-instagram"></i>
      ...
      <a class="p-relative" href="{{ get_option('primary_data',true,true,false,current_locale())->socials->linkedin }}"><i class="fab fa-linkedin"></i>
