                  ...
                  <div class="tp-app__wrapper">
                     ...
                     <div class="tp-app__download">
                        ...
                        <div class="tp-app__thumb-sm d-flex">
                           @isset(get_option('header_footer',true,true,false,current_locale())->footer_button_image)
                           <div class="tp-app__thumb-sm-1">
                             <a href="{{ get_option('header_footer',true,true,false,current_locale())->footer->right_image_link ?? '' }}"><img src="{{ asset(get_option('header_footer',true,true,false,current_locale())->footer_button_image ?? '' ) }}" alt=""></a>
                           </div>
                           @endisset

                           @isset(get_option('header_footer',true,true,false,current_locale())->footer_left_button_image)
                           <div class="tp-app__thumb-sm-2">
                            <a href="{{ get_option('header_footer',true,true,false,current_locale())->footer->right_image_link ?? '' }}"><img src="{{ asset(get_option('header_footer',true,true,false,current_locale())->footer_left_button_image ?? '' ) }}" alt=""></a>
                         </div>
                         @endisset
                        </div>
                     </div>
