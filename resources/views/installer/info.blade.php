...
<div class="col-sm-12">
   ...
   <form class="installer_form_instant_reload" method="post" action="{{ route('install.store') }}">
      ...
      <div class="form-group mb-2">
         ...
         <input type="text" name="db_connection" class="form-control" required="" placeholder="{{ __('mysql') }}" maxlength="20" value="mysql">
      </div>
      <div class="form-row">
         <div class="col-sm-6">
            <div class="form-group">
               <label>{{ __('Database Host') }}</label>
               <input type="text" name="db_host" class="form-control" required="" placeholder="{{ __('localhost') }}" maxlength="20" value="localhost">
            </div>
         </div>
         <div class="col-sm-6">
            <div class="form-group">
      ...
      <div class="form-group">
         ...
         <input type="text" name="db_name" class="form-control" required="" placeholder="{{ __('Enter Your Database Name') }}">
      </div>
      <div class="form-group">
         <label>{{ __('Database Username') }}</label>
         <input type="text" name="db_user" class="form-control" required="" placeholder="{{ __('Enter Your Database Username') }}">
      </div>
      <div class="form-group">
         <label>{{ __('Database Password') }}</label>
         <input type="text" name="db_pass" class="form-control"  placeholder="{{ __('Enter Your Database Password') }}">
