...
<ul class="navbar-nav">
  ...
  <li class="nav-item">
   ...
   <li class="nav-item">
    ...
    <li class="nav-item">
        <a class="nav-link {{ Request::is('admin/about*') ? 'active' : '' }}" href="#navbar-about" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-forms">
            <i class="fi fi-rs-comment-question"></i>
            <span class="nav-link-text">{{ __('About Us') }}</span>
        </a>
        <div class="collapse" id="navbar-about">
            <ul class="nav nav-sm flex-column">
                @foreach(get_option('languages',true) as $key => $language)
                    <li class="nav-item">
                        <a href="{{ route('admin.about.index') }}?language={{$key}}" class="nav-link">{{ strtoupper($language)}}</a>
                    </li>
                @endforeach
            </ul>
        </div>
...
<ul class="navbar-nav mb-md-3">
    <li class="nav-item">
        <a class="nav-link {{ Request::is('admin/page-settings*') ? 'active' : '' }}" href="#navbar-page-sittings" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-forms">
            <i class="fi fi-rs-magic-wand"></i>
            <span class="nav-link-text">{{ __('Page Settings') }}</span>
        </a>
        <div class="collapse" id="navbar-page-sittings">
            <ul class="nav nav-sm flex-column">
                @foreach(get_option('languages',true) as $key => $language)
                    <li class="nav-item">
                            <a href="{{ route('admin.page-settings.index') }}?language={{$key}}" class="nav-link">{{ strtoupper($language)}}</a>
                    </li>
                @endforeach
            </ul>
        </div>
