      ...
      <div class="row list-item-area${total_exisit_card}">
         ...
         <div class="col-6">
            <div class="form-group">
               ...
               <input  type="text" class="form-control" name="section[${total_exisit_card}][value][1][description]" placeholder="Example: Banana is a healthy food" value=""   maxlength="50" />
            </div>
         </div>
      </div>
      <div class="row">
...
$(document).on('click','.add-more-option-item',function(){
    ...
    <div class="col-6 item-${key}-${check_option_item+1}">
        <div class="form-group">
            ...
            <input  type="text" class="form-control" name="section[${key}][value][${check_option_item+1}][description]" placeholder="Example: Banana is a healthy food" value=""   maxlength="50" />
        </div>
    </div>`;
